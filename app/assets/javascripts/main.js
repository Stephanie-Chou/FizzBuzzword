$(document).ready(function(){
	...
	$("#submit_btn").on("click", function(e){
		...
		var request = $.ajax(
			{url: "https://www.linkedin.com/uas/oauth2/authorization?response_type=code&client_id="+keys.YOUR_API_KEY+"&scope="+keys.SCOPE+"&state="+keys.STATE+"&redirect_uri="+keys.YOUR_REDIRECT_URI,
				type: 'GET',
				jsonp: 'callback',
				dataType: 'jsonp',
